export const D1_MIGRATIONS = [
  ...
  },
  {
	...
	{
		id: "2026-09-13-telegram-storage-cleanup",
		file: "worker/migrations/2026-09-13-telegram-storage-cleanup.sql",
		artifacts: ["table:pending_storage_delete", "index:idx_pending_storage_delete_next_retry"],
	},
	{
		id: "2026-09-13-telegram-storage",
		file: "worker/migrations/2026-09-13-telegram-storage.sql",
		artifacts: ["table:telegram_storage_objects", "index:idx_telegram_storage_file_id", "index:idx_telegram_storage_message"],
	},
	{
		id: "2026-09-13-telegram-storage-v3",
		file: "worker/migrations/2026-09-13-telegram-storage-v3.sql",
		artifacts: ["table:telegram_storage_routes", "index:idx_telegram_storage_routes_backend", "column:uploaded_files.content_sha256", "index:idx_uploaded_files_owner_sha256"],
	},
	{
		id: "2026-09-13-telegram-storage-chunked",
		file: "worker/migrations/2026-09-13-telegram-storage-chunked.sql",
		artifacts: [
			"column:telegram_storage_objects.storage_mode",
			"column:telegram_storage_objects.chunk_count",
			"column:telegram_storage_objects.plaintext_size",
			"column:telegram_storage_objects.encryption_version",
			"table:telegram_storage_uploads",
			"table:telegram_storage_upload_parts",
			"index:idx_telegram_storage_upload_parts_upload_status",
			"index:idx_telegram_storage_uploads_owner_client"
		],
	},
];
