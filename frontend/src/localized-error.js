...
const fixedErrorTranslations = new Map([
  ...
  ['当前部署没有配置 Telegram 文件存储，无法统计存储空间', 'Telegram storage is not configured for this deployment, so storage usage cannot be calculated'],
  ...
  ['当前部署没有配置 Telegram 文件存储，无法上传附件', 'Telegram storage is not configured for this deployment, so attachments cannot be uploaded'],
  ['请选择文件', 'Please select a file'],
  ['当前部署没有配置 Telegram 文件存储，无法读取附件', 'Telegram storage is not configured for this deployment, so attachments cannot be read'],
